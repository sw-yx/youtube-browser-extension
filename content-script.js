...
if (isOnChannel && SortMenuEl?.children?.length < 1) {
  ...
  <ul style="display: flex; gap: 3rem">
    <li><a style="font-size: initial;" style-target="label-text" class="style-scope yt-dropdown-menu" href="${loc + urls.popular}">Popular</a></li>
    <li><a style="font-size: initial;" style-target="label-text" class="style-scope yt-dropdown-menu" href="${loc + urls.oldest}">Oldest</a></li>
    <li><a style="font-size: initial;" style-target="label-text" class="style-scope yt-dropdown-menu" href="${loc + urls.newest}">Newest</a></li>
  </ul>
  `
}
